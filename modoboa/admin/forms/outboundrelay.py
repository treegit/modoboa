...
class OutboundRelayFormGeneral(forms.ModelForm, DynamicForm):
    ...
    def __init__(self, user, *args, **kwargs):
        ...
        super(OutboundRelayFormGeneral, self).__init__(*args, **kwargs)
    ...
    def clean(self):
        ...
        """
        cleaned_data = super(OutboundRelayFormGeneral, self).clean()
        if self._errors:
            return cleaned_data
        condition = (
    ...
    def save(self, user, commit=True, domalias_post_create=False):
        ...
        """
        d = super(OutboundRelayFormGeneral, self).save(commit=False)
...
class OutboundRelayFormOptions(forms.Form):
    ...
    def __init__(self, user, *args, **kwargs):
        super(OutboundRelayFormOptions, self).__init__(*args, **kwargs)
    ...
    def clean(self):
        ...
        cleaned_data = super(OutboundRelayFormOptions, self).clean()
...
class OutboundRelayForm(TabForms):
    """Domain edition form."""
    ...
    def __init__(self, request, *args, **kwargs):
        ...
        super(OutboundRelayForm, self).__init__(request, *args, **kwargs)
    ...
    def is_valid(self):
        ...
        return super(OutboundRelayForm, self).is_valid()
    ...
    def save(self):
        ...
        options = {}
        if isinstance(first_form, OutboundRelayFormGeneral):
...
class DomainWizard(WizardForm):
    ...
    def __init__(self, request):
        ...
        self.add_step(
            WizardStep(
                "general", OutboundRelayFormGeneral, _("General"),
        ...
        self.add_step(
            WizardStep(
                "options", OutboundRelayFormOptions, _("Options"),
